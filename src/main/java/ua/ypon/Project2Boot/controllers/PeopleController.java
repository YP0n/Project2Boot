...
public class PeopleController {
    ...
    public String index(Model model) {
        //Получимо усіх людей із Repository и передадимо на відображення в представлення
    ...
    public String create(@ModelAttribute("person") @Valid Person person,
        ...
        // людину(пустий об"єкт класа Person)
        if(bindingResult.hasErrors())
            return "people/new";

        peopleService.save(person);//потім ця ж анотація впроавджує значення із форми
        // в цей об"єкт класа Person. І цей об"єкт додає в модель.
